    ...
    <section className='py-12 lg:py-24'>
      <div className='container mx-auto'>
        ...
        <div className='text-center mb-20'>
          <div className='text-orange font-semibold mb-3'>Our Affordable Prices</div>
          <h2 className='h2 mb-3'>How Big Is Your Pet?</h2>
          <p className='text-lg text-blue'>Choose your pet category</p>
        </div>
        {/* grid */}
        <div className='grid grid-cols-4 lg:gap-[30px]'>
